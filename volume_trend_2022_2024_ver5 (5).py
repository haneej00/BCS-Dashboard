...
fig.update_layout(title=title + " - Avg. Monthly Volume", xaxis_title='Month', yaxis_title='Average Value1')
...
fig.add_trace(go.Scatter(
    ...
    y=data['Transaction'],
    mode='lines+markers',
    name='Volume by Transaction',
    line=dict(color='blue')
))
fig.update_layout(
    title=title + "Monthly Avg. Volume by Transaction",
    xaxis_title='Month',
    yaxis_title='Average Value2',
    height=500
)
...
st.subheader("📋 6 - month basis Volume & Transaction")
